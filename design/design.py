...
from chipflow_digital_ip.io import UARTPeripheral, SPIPeripheral
from chipflow_lib.platforms import attach_data, SoftwareBuild, UARTSignature, SPISignature
...
class MySoC(wiring.Component):
    ...
    def elaborate(self, platform):
        ...
        # SPI 0
        m.submodules.spi_0 = spi_0 = SPIPeripheral()
        csr_decoder.add(spi_0.bus, name="spi_0", addr=self.csr_spi_base + 0 * self.periph_offset - self.csr_base)
        connect(m, flipped(self.spi_0), spi_0.spi_pins)
